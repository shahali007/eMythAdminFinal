...
<html lang="en">
<head>
<title>Content - Insert (Bangla) - Double Tab Column</title>
<meta charset="UTF-8">
		...
		<div class="col-sm-10 col-xs-12 main-details">				
			 <!-- Nav tabs -->
			  <ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#ContentInsert1" aria-controls="home" role="tab" data-toggle="tab">Insert</a></li>
				<li role="presentation"><a href="#ContentInsert2" aria-controls="ContentInsert2" role="tab" data-toggle="tab">SEO</a></li>
			  </ul>
	<!-- Tab panes -->
		...
		<div role="tabpanel" class="tab-pane active" id="ContentInsert1">
			<div class="row">
				<div class="col-sm-6 col-sm-offset-4">
					<h3>Content - Insert (Bangla) - Double Tab Column</h3>
				</div>
				<div class="col-sm-2">
			...
			<div role="tabpanel" class="tab-pane" id="ContentInsert2">
				<div class="row">
				...
				<div class="row">
					...
					<form action="">	
						...
						<div class="row">
							<div class="col-sm-12">
								<label for="NewsMetaKeywords">News Meta Keywords</label>
								<input type="text" class="form-control" id="NewsMetaKeywords">
							</div>
						</div>		
						<div class="row">
							<div class="col-sm-12">
						...
						<div class="row">									
							<div class="col-sm-12">
								<label for="ImageAltDesSm">Image ALT Description (Small)</label>
								<input type="text" class="form-control" id="ImageAltDesSm">
							</div>
						</div>	
						<div class="row">
							<div class="col-sm-12">
								<label for="ImageAltDesBg">Image ALT Description (Big)</label>
								<input type="text" class="form-control" id="ImageAltDesBg" >
							</div>
						</div>	
						<div class="row">
							<div class="col-sm-12">
